      ...
      <section className="flex gap-8 max-sm:flex-col">
        <div className="companion-section">
          ...
          >
            <div
              className={cn(
                "absolute transition-opasity duration-1000",
        ...
        <div className="user-section">
          ...
          <button className="btn-mic" onClick={() => toggleMicrofone()} disabled={callStatus !== CallStatus.ACTIVE}>
            <Image
